...
class PageListTest(TestCase):
    ...
    def setUp(self):
        self.paginator = DefaultPaginator(list(range(30)), 7, orphans=2)
    ...
    def test_paginated(self):
        ...
        page = DefaultPaginator(list(range(10)), 10).page(1)
