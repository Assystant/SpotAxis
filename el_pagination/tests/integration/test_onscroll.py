...
class OnScrollPaginationTest(SeleniumTestCase):
    ...
    def test_new_elements_loaded(self):
        ...
        self.get()
        with self.assertNewElements('object', list(range(1, 21))):
            self.scroll_down()
    ...
    def test_direct_link(self):
        ...
        self.get(page=3)
        self.assertElements('object', list(range(21, 31)))
    ...
    def test_subsequent_page(self):
        ...
        self.get(page=2)
        with self.assertNewElements('object', list(range(11, 31))):
            self.scroll_down()
    ...
    def test_multiple_show_more(self):
        ...
        for page in range(2, 5):
            expected_range = list(range(1, 10 * page + 1))
            with self.assertSameURL():
    ...
    def test_scrolling_last_page(self):
        ...
        self.get(page=5)
        with self.assertNewElements('object', list(range(41, 51))):
            self.scroll_down()
