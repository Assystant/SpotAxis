...
urlpatterns = [
    ...
    url(r'^profile/(?P<candidate_id>\d+)/$', candidates_views.edit_curriculum, name='candidates_edit_curriculum'), # TODO CHECAR / AL FINAL DE LA URL
    ...
    url(r'^profile/pdf/(?P<candidate_id>\d+)/(?P<template>\d+)/$', candidates_views.curriculum_to_pdf, name='vacancies_curriculum_to_pdf_with_template'),
    ...
    url(r'^login/$', django_auth_views.login, {'template_name': 'login.html', 'extra_context': {'static_header': True}}, name='auth_login'),
    ...
    url(r'^signup/complete/$', common_views.registration_complete,{'template_name': 'new_registration_messages.html'}, name='common_registration_complete'),
    ...
    url(r'^ajax/jobs-postulate/$', common_ajax_views.vacancies_postulate),
    ...
    url(r'^ajax/jobs-answer-question/$', common_ajax_views.vacancies_answer_question),
    ...
    url(r'^ajax/generate_public_cv/$',common_ajax_views.generate_public_cv),
    url(r'^ajax/pricingrequest/$', common_ajax_views.public_contact_form),
    ...
    url(r'^jobs/(?P<vacancy_id>\d+)/(?P<vacancy_stage>\d+)/$', vacancy_views.vacancy_stage_details, name='vacancies_get_vacancy_stage_details'),
