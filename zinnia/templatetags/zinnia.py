...
from ..settings import DEFAULT_POST_IMAGE
from ..templates import loop_template_list
from TRM.settings import STATIC_URL
...
def get_recent_entries(number=5, template='zinnia/tags/entries_recent.html'):
    ...
    return {'template': template,
            ...
            'DEFAULT_POST_IMAGE': DEFAULT_POST_IMAGE}
...
@register.inclusion_tag('zinnia/tags/dummy.html', takes_context=True)
def get_similar_entries(context, number=3,
